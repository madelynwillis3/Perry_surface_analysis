...
plots <- top_each_ds %>%
  group_split(nutrient_lab) %>%
  lapply(function(d){
    nut <- unique(d$nutrient_lab)
    xmax <- xlim_tbl$xmax[xlim_tbl$nutrient_lab == nut][1]
